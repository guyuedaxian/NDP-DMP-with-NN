...
default_model_save_path = os.path.join(dirname(dirname(realpath(__file__))),'models/cnn_encoder_decoder','cfcimednet-40x40-smnist-adam-end-to-end')
default_cnn_model_load_path = os.path.join(dirname(dirname(realpath(__file__))), 'models/mnist_cnn/mnist_cnn.model')

# default_data_path = os.path.join(dirname(dirname(realpath(__file__))), 'data/s-mnist/40x40-smnist-with-awgn.mat')
# default_model_save_path = os.path.join(dirname(dirname(realpath(__file__))),'models/cnn_encoder_decoder','cfcimednet-40x40-smnist-adam-with-awgn-end-to-end')
# default_cnn_model_load_path = os.path.join(dirname(dirname(realpath(__file__))), 'models/nmnist_cnn/nmnist-with-awgn-cnn.model')

# default_data_path = os.path.join(dirname(dirname(realpath(__file__))), 'data/s-mnist/40x40-smnist-with-motion-blur.mat')
# default_model_save_path = os.path.join(dirname(dirname(realpath(__file__))),'models/cnn_encoder_decoder','cfcimednet-40x40-smnist-adam-with-motion-blur-end-to-end')
# default_cnn_model_load_path = os.path.join(dirname(dirname(realpath(__file__))), 'models/nmnist_cnn/nmnist-with-motion-blur-cnn.model')
...
# default_model_save_path = os.path.join(dirname(dirname(realpath(__file__))),'models/cnn_encoder_decoder','cfcimednet-40x40-smnist-adam-with-reduced-contrast-and-awgn-end-to-end')
# default_cnn_model_load_path = os.path.join(dirname(dirname(realpath(__file__))), 'models/nmnist_cnn/nmnist-with-reduced-contrast-and-awgn-cnn.model')
...
default_val_fail = 60
# default_hidden_layer_sizes = ['20', '35'] # 600, 200, 20, 35
default_hidden_layer_sizes = ['600', '200', '20', '35']
# Parse arguments
...
parser.add_argument('--device', type=int, default=1,
                    help='no select CUDA device (default: 1)')
